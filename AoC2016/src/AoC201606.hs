...
generateFrequencies xs = frequencySort $ letterFrequency xs

-- Parsers

parsedInput :: String -> Either ParseError [String]
parsedInput xs = parse wordsParser "test" xs
